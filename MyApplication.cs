...
namespace Template
{
    class MyApplication
    {
        ...
        public void Init()
        {
            ...
            worldNode.children.Add(new Light(new Vector3(0, 0, 2000), new Vector3(10, 1, 10), lights));
            worldNode.children.Add(new Light(new Vector3(2000, 0, 0), new Vector3(10, 1, -10), lights));
            worldNode.children.Add(new Light(new Vector3(0, 2000, 0), new Vector3(-10, 1, 0), lights));
        }
